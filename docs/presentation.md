...
Все это возможно сделать с помощью поставки данных в блокчейн. Так как, отправка данных требует оплаты комиссии за транзакцию, такие сервисы могут предоставляться только на коммерческой основе.
...
Перспективы монетизации - созданием подписки на платные материалы. Хотя желательно максимально сохранить открытый доступ к информации.

---

# Проблемы и пути их решения #5

## Отсутствие обозревателя блокчейн

Разработчикам, и обычным пользователем нужен обозреватель блокчейн(blockchain explorer).

Часто, после транзакции можно получить ссылки на транзакцию в блокчейне.

Сейчас нет такого ресурса на который можно сослаться.
